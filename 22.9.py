...
user_number = int(input('Введите нужное число: '))
...
if " " not in sequence_numbers:
    print("\nВ вводе отсутствуют пробелы (введите числа, по условию ввода)")
    sequence_numbers = input('Введите целые числа через пробел: ')
if not is_int(sequence_numbers):
    print('\nВ вводе содержатся не цифры/целые числа (введите числа, согласно условиям ввода.)\n')
    print(error)
else:
...
def binary_search(array, element, left, right):
    try:
        ...
        return 'Число выходит за диапазон списка, введите число меньше'

print(f'Упорядоченный список по возрастанию: {list_sequence_numbers}')
